                        ...
                        <asp:Panel ID="pnlAdvanced" runat="server" CssClass="margin-t-md">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <Rock:CodeEditor ID="ceEmailTemplate" EditorHeight="500" Label="Message Body" EditorMode="Html" EditorTheme="Rock" runat="server" SourceTypeName="Rock.Model.SystemEmail, Rock" PropertyName="Body" Required="true" />
                                </div>
                                <div class="col-md-4">

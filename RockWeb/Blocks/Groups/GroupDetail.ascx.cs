...
namespace RockWeb.Blocks.Groups
{
    ...
    public partial class GroupDetail : ContextEntityBlock, IDetailBlock
    {
        ...
        private void LoadDropDowns( RockContext rockContext )
        {
            ...
            var communicationTemplateService = new SystemEmailService( rockContext );

            var systemCommunications = communicationTemplateService.Queryable()
                .AsNoTracking()
                .OrderBy( t => t.Title )
                .Select( a => new
                {
        ...
        private void CreateSystemCommunicationDropDownLists( RockContext rockContext )
        {
            ...
            var systemCommunications = new SystemEmailService( rockContext )
                .Queryable()
                .OrderBy( e => e.Title )

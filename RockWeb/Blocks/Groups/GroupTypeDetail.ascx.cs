    ...
    public partial class GroupTypeDetail : RockBlock, IDetailBlock
    {
        ...
        public void ShowDetail( int groupTypeId )
        {
            ...
            if ( groupType == null )
            {
                ...
                var systemCommunicationIdLookup = new SystemEmailService( new RockContext() ).Queryable().ToDictionary( k => k.Guid, v => v.Id );
                ...
                groupType.ScheduleReminderSystemCommunicationId = systemCommunicationIdLookup.GetValueOrNull( Rock.SystemGuid.SystemCommunication.SCHEDULING_REMAINDER.AsGuid() );
        ...
        private void LoadDropDowns( int? groupTypeId )
        {
            ...
            var systemCommunications = new SystemEmailService( new RockContext() ).Queryable().OrderBy( t => t.Title ).Select( a => new
            {
                a.Id,
                a.Title
            } );
